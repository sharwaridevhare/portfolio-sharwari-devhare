      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="font-playfair text-4xl md:text-5xl font-bold text-deep-navy mb-8">
              About Me
            </h2>
            ...
            <div className="grid grid-cols-2 gap-6 pt-6">
              <div className="bg-cream/50 p-4 rounded-lg">
                <h3 className="font-semibold text-deep-navy mb-2">Education</h3>
                <p className="text-sm text-foreground/70">AI & Data Science Engineering</p>
                <p className="text-sm text-royal-blue">KDK College of Engineering</p>
              </div>
              <div className="bg-cream/50 p-4 rounded-lg">
                <h3 className="font-semibold text-deep-navy mb-2">Focus Areas</h3>
                <p className="text-sm text-foreground/70">Artificial Intelligence</p>
                <p className="text-sm text-royal-blue">Data Science & Analytics</p>
              </div>
            </div>
          </div>
          
          <div className="relative">
            <div className="bg-gradient-to-br from-royal-blue/10 to-deep-navy/10 rounded-2xl p-8 h-96 flex items-center justify-center">
              <div className="text-center">
                <div className="w-24 h-24 bg-royal-blue rounded-full flex items-center justify-center mx-auto mb-6">
                  <span className="text-white text-3xl font-bold">SD</span>
                </div>
                <h3 className="font-playfair text-2xl font-semibold text-deep-navy mb-2">
                  Sharwari Devhare
                </h3>
                <p className="text-royal-blue font-medium">AI & Data Science Engineer</p>
                <div className="mt-6 flex justify-center space-x-4">
                  <div className="w-3 h-3 bg-royal-blue rounded-full"></div>
                  <div className="w-3 h-3 bg-deep-navy rounded-full"></div>
                  <div className="w-3 h-3 bg-royal-blue/50 rounded-full"></div>
                </div>
              </div>
            </div>
            
            {/* Decorative elements */}
            <div className="absolute -top-4 -right-4 w-20 h-20 bg-royal-blue/20 rounded-full blur-xl"></div>
            <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-deep-navy/20 rounded-full blur-xl"></div>
          </div>
        </div>
      </div>
    </section>
